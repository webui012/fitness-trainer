...
const validate = values => {
  ...
  if (!values.password1) {
    ...
    errors.password1 = 'Must conteined digits end characters'
  }
   if (!values.password2) {
  ...
  return <div className='signup-page'>
    <form onSubmit={handleSubmit}>
      <fieldset className='signup-form'>
        ...
        <label className='form-input'>
          <Field className='form' name='email' type='email' component={renderField} label='Введите адрес электронной почты' />
        </label>

        <label className='form-input'>
          <Field className='form' name='password1' type='password' component={renderField} label='Введите пароль' />
        </label>

        <label className='form-input'>
          <Field className='form' name='password2' type='password' component={renderField} label='Повторите пароль' />
        </label>
